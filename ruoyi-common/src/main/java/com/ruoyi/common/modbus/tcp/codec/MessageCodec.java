package com.ruoyi.common.modbus.tcp.codec;
...
public class MessageCodec extends ByteToMessageCodec<ModbusRequest> {
    @Override
    protected void encode(ChannelHandlerContext channelHandlerContext, ModbusRequest request, ByteBuf buf)
            throws Exception {
    ...
    // private void writeMultipleRegister(ModbusPayLoad<short[]> payload,ByteBuf
    // buf){
    // currency(payload,buf);
